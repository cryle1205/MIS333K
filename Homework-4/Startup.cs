...
namespace Le_Crystal_HW4
{
    public class Startup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            String connectionString = "Server=tcp:sp22lecrystalhw4.database.windows.net,1433;Initial Catalog=sp22lecrystalhw4;" +
                "Persist Security Info=False;User ID=MISAdmin;Password=Password123;MultipleActiveResultSets=True;Encrypt=True;" +
                "TrustServerCertificate=False;Connection Timeout=30;";
            services.AddDbContext<AppDbContext>(options => options.UseSqlServer(connectionString));

            //(For HW4 and beyond) Uncomment these lines once you have added Identity to your project
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            //(HW4 & Beyond) Once you have added Identity into your project, you will need to uncomment these lines
